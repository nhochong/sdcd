<?php
class Admin_Form_LoaiTinTuc extends Zend_Form{
    ...
    {  	
		...
		$parentOptions = Khcn_Api::_()->getDbTable('loai_tin_tuc', 'default')->getParentListAssoc();
		...
		$link = $url->url(array('module' => 'admin','controller' => 'loai-tin-tuc','action' => 'index'),null,true);
