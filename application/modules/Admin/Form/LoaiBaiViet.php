<?php
class Admin_Form_LoaiBaiViet extends Zend_Form{
    ...
    {  	
		...
		$link = $url->url(array('module' => 'admin','controller' => 'loai-bai-viet','action' => 'index'),null,true);
		...
		$this->addElements(array($ten,$submitCon,$submitExit,$cancel));						
