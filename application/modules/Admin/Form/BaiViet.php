...
class Admin_Form_BaiViet extends Zend_Form{
    ...
    {  	
		...
		$photo->setLabel('Upload hình')
				...
				->setDestination(BASE_PATH . '/upload/files/bai_viet')
		...
		$this->addElements(array($loai_bai_viet_id, $tieu_de, $noi_dung, $trang_thai, $noi_bat, $photo, $submitCon, $submitExit, $cancel));
