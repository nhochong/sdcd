<?php
class Admin_Form_ThongTin extends Zend_Form{
    ...
    {  	
        ...
        $loai_thong_tin_id->setLabel('Loại (*)')
		...
		$this->addElements(array($loai_thong_tin_id, $tieu_de, $noi_dung, $trang_thai, $submitCon, $submitExit, $cancel));						
