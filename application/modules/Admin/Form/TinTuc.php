...
class Admin_Form_TinTuc extends Zend_Form{
    ...
    {  	
		...
		$cateOptions = Khcn_Api::_()->getDbTable('loai_tin_tuc', 'default')->getListAssoc();
        $loai_tin_tuc_id = new Zend_Form_Element_Select('loai_tin_tuc_id');
        $loai_tin_tuc_id->setLabel('Loại (*)')
		...
		$this->addElements(array($loai_tin_tuc_id, $tieu_de, $noi_dung, $trang_thai, $noi_bat, $photo, $submitCon, $submitExit, $cancel));						
