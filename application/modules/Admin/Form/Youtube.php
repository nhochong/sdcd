<?php
class Admin_Form_Youtube extends Zend_Form{
    ...
    {  	
		...
		$youtubeChannel = new Zend_Form_Element_Text('link');       
        $youtubeChannel->setLabel('Youtube Channel')
            ->setRequired(true)
            ->addFilter('StripTags')
            ->addFilter('StringTrim')
            ->addValidator('NotEmpty')
		...
		$link = $url->url(array('module' => 'admin','controller' => 'video','action' => 'youtube-list'),null,true);
		...
		$this->addElements(array($tieu_de,$youtubeChannel,$submitCon,$submitExit,$cancel));						
