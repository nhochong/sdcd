...
class Khcn_Loader
{
   ...
   * 
   * @param string $class
   * @throws Khcn_Loader_Exception If unable to load
   */
  public static function loadClass($class)
  {
    if( !class_exists($class, false) ) {
      if( !self::autoload($class) ) {
        throw new Khcn_Loader_Exception(sprintf('Could not load class: %s', $class));
      }
    }
  }
   ...
   * @return mixed
   */
  public function load($class, $api = false)
  {
