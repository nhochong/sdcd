 ...
 * @license    http://www.socialengine.net/license/
 */
class Khcn_Controller_Action_Helper_RequireSubject extends
  Khcn_Controller_Action_Helper_RequireAbstract
{
  protected $_errorAction = array('requiresubject', 'error', 'default');
  ...
  public function reset()
  {
    ...
    $this->_errorAction = array('requiresubject', 'error', 'default');
