 ...
 * @license    http://www.socialengine.net/license/
 */
class Khcn_Application_Module_Bootstrap extends Zend_Application_Module_Bootstrap
{
  ...
  {
      throw new Khcn_Exception("Disabled");
      
      if (null === $this->_resourceLoader) {
          $this->setResourceLoader(new Khcn_Application_Module_Autoloader(array(
