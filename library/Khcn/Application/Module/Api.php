 ...
 * @license    http://www.socialKhcn.net/license/
 */
abstract class Khcn_Application_Module_Api
{
  ...
  public function api()
  {
    return Khcn_Api::_()->setCurrentModule($this->getModuleName());
  }
  ...
  public function __call($type, $args)
  {
    ...
    //return Khcn_Api::_()->load(strtolower($this->getModuleName()), $type, $resource);
  }
  ...
  {
    $table = Khcn_Api::_()->getItemTable($type);
    $row = $table->createRow();
    ...
    // Pre-create hook
    //Khcn_Hooks_Dispatcher::getInstance()
  ...
  protected function _isTypeSupported($type)
  {
    ...
    {
      //throw new Khcn_Exception(sprintf('Type "%s" is no supported', $type));
    }
  }
  ...
  protected function _getIdentity($type, $identity)
  {
    ...
    {
      throw new Khcn_Exception('Not an identity');
    }
  }
}