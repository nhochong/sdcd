 ...
 * @version    $Id: Abstract.php 8328 2011-01-28 05:11:15Z john $
 */
 ...
 * @license    http://www.socialengine.net/license/
 */
abstract class Khcn_Application_Bootstrap_Abstract
{
  /**
  ...
  {
    // Get options
    if( $application instanceof Khcn_Application )
    {
      $options = $application->getOptions();
      $autoloader = $application->getAutoloader();
    }
    else if( $application instanceof Khcn_Application_Bootstrap_Abstract )
    {
    ...
    {
      throw new Khcn_Application_Bootstrap_Exception('Application not instance of Khcn_Application or Khcn_Application_Bootstrap_Abstract');
    }
  ...
  public function run()
  {
    throw new Khcn_Application_Bootstrap_Exception("Run must be implemented in child classes");
  }
  ...
  protected function _bootstrap($resource = null)
  {
    ...
    {
      throw new Khcn_Application_Bootstrap_Exception('Invalid argument passed to ' . __METHOD__);
    }
  }
  ...
  protected function _executeResource($resource)
  {
    ...
    {
      throw new Khcn_Application_Bootstrap_Exception('Cyclical dependency detected.');
    }
    ...
    throw new Khcn_Application_Bootstrap_Exception(sprintf('Unknown resource %s', $resource));
  }
  ...
  public function getModuleName()
  {
    if( $this->_moduleName === null )
    {
      ...
      {
        throw new Khcn_Application_Bootstrap_Exception(sprintf('Unable to get module name in class: %s', $class));
      }
