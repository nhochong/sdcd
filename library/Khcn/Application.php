...
class Khcn_Application
{
  ...
  static public function _()
  {
    if( null === self::$_instance ) {
      throw new Khcn_Application_Exception("No instance configured");
    }
  ...
  static public function setInstance(Khcn_Application $application)
  {
  ...
  public function getBootstrap()
  {
    if( null === $this->_bootstrap ) {
      throw new Khcn_Application_Exception('No bootstrap registered');
    }
  ...
  {
    if( $spec instanceof Khcn_Application_Bootstrap_Abstract ) {
      ...
      if( !file_exists($path) ) {
        throw new Khcn_Application_Exception('Bootstrap not found');
      }
      ...
      throw new Khcn_Application_Exception('Invalid spec');
    }
