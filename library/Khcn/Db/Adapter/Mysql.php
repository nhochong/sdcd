...
class Khcn_Db_Adapter_Mysql extends Zend_Db_Adapter_Abstract
{
    /**
    ...
    private function _throwException($message=null)
    {
        ...
        throw new Khcn_Db_Adapter_Mysql_Exception($message);
    }
    ...
    {
        return new Khcn_Db_Statement_Mysql($this, $sql);
    }
