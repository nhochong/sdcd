 ...
 * @license    http://www.socialengine.net/license/
 */
class Khcn_View_Helper_String extends Zend_View_Helper_Abstract
{
  /**
   * Accessor
   * 
  ...
  {
    if( Khcn_String::strlen($string) <= $length ) {
      return $string;
    }
    if( null === $chopString ) {
      $chopString = '...';
    ...
    return Khcn_String::substr($string, 0, $length) . $chopString;
  }
